      ...
      Container(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Text(
              "Catat Pengeluaran dan Pemasukan lebih efektif !",
                      ...
                      (index) => Column(
                            ...
                            children: [
                              AnimatedContainer(
                                ...
                                decoration: BoxDecoration(color: (_currentPage == index) ? Colors.white : Colors.white.withOpacity(.4), borderRadius: BorderRadius.circular(20)),
                              )
                            ],
                          ))),
              SizedBox(
              ...
              Material(
                ...
                child: InkWell(
                    ...
                    onTap: () async {
                      ...
                      _pageController.nextPage(duration: Duration(milliseconds: 600), curve: Curves.easeInOutQuint);
                    },
                    child: AnimatedContainer(
                      width: (_currentPage == daftarHalaman.length - 1) ? 120 : 48,
                      height: 48,
                      duration: Duration(milliseconds: 300),
